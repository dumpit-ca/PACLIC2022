            ...
            <div class="timeline">
              ...
              <div class="timeline-wrapper timeline-wrapper-success">
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p>Alpha 5 has arrived just over a month after Alpha 4 with some major feature improvements and a
                      boat load of bug fixes.</p>
                  </div>
                  <div class="timeline-footer d-flex align-items-center flex-wrap">
                    <i class="mdi mdi-heart-outline text-muted mr-1"></i>
                    <span>19</span>
              ...
              <div class="timeline-wrapper timeline-inverted timeline-wrapper-info">
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p>Alpha 4 is here to address those pesky build and package errors, a few CSS bugs, and some
                      documentation inconsistencies we introduced in our last release.</p>
                  </div>
                  <div class="timeline-footer d-flex align-items-center flex-wrap">
                    <i class="mdi mdi-heart-outline text-muted mr-1"></i>
                    <span>19</span>
              ...
              <div class="timeline-wrapper timeline-wrapper-primary">
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p>Alpha 3 has landed! We have an overhauled grid, updated form controls, a new font stack, tons of
              ...
              <div class="timeline-wrapper timeline-inverted timeline-wrapper-info">
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p>The general plan for v4’s development starts with a few alpha releases. We’re a little behind on
                      that, but should be getting caught up as the year winds down.</p>
                  </div>
                  <div class="timeline-footer d-flex align-items-center flex-wrap">
                    <i class="mdi mdi-heart-outline text-muted mr-1"></i>
                    <span>32</span>
